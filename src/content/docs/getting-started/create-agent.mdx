...
<img src={agentList.src} alt="Voice Agents page showing the heading, subtitle, an amber Create Agent button, and an empty state message reading No agents yet" />
...
<img src={agentForm.src} alt="New Agent form with Agent Name text field, Agent Prompt textarea, and the beginning of Voice and Session Settings below" />
...
<img src={agentConfig.src} alt="Voice and Session Settings section showing dropdowns for Voice, Model, Noise Reduction, Voice Activity Detection, Eagerness, a numeric input for Speed, and an empty Knowledge Bases section" />
